...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=False,
        help=
        "Update ~/.pro/config directly without prompting by passing in key-value pairs."
    )
    ...
    if not app.is_configured():
        from pro import configure, parse_settings
        configure(app, no_prompt=args.no_prompt, settings=parse_settings(args.update))
